...
Basically it's a language in which we can write live-scripts in webpages and much more. And no, it has nothing to do with Java and no prior knowledge of JAVA is required.
...
Now it's much more than that, it has something for everyone.
 It can used for front-end, back-end , app development, etc
